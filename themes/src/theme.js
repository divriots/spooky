...
export const setTheme = (_theme) => {
  ...
  const obj = {
    ...
    '--simba-font-creepster': family['creepster'],
    ...
    '--simba-color-secondary-50': colors.amber[50],
    '--simba-color-secondary-100': colors.amber[100],
    '--simba-color-secondary-200': colors.amber[200],
    '--simba-color-secondary-300': colors.amber[300],
    '--simba-color-secondary-400': colors.amber[400],
    '--simba-color-secondary-500': colors.amber[500],
    '--simba-color-secondary-600': colors.amber[600],
    '--simba-color-secondary-700': colors.amber[700],
    '--simba-color-secondary-800': colors.amber[800],
    '--simba-color-secondary-900': colors.amber[900],
